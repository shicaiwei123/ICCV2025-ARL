...
from dataset.grouptransfer import *
import pdb
import random
import glob
    ...
    def __init__(self, args, mode='train'):
        ...
        with open('./data/VGGSound/vggsound.csv') as f:
            ...
            for item in csv_reader:
                ...
                if item[3] == 'train':
                    video_dir = os.path.join('./train_test_data/vggsound/', 'video/train-set-img', 'Image-{:02d}-FPS'.format(self.args.fps), item[0]+'_'+item[1].zfill(6)+'.mp4')
                    audio_dir = os.path.join('./train_test_data/vggsound/', 'audio/train-audios/train-set', item[0]+'_'+item[1].zfill(6)+'.wav')
                    # print(video_dir)
                    # print(audio_dir)
                    ...
                    if os.path.exists(video_dir) and os.path.exists(audio_dir) and len(listdir_nohidden(video_dir))>=3 :
                ...
                if item[3] == 'test':
                    ...
                    video_dir = os.path.join('./train_test_data/vggsound/', 'video/test-set-img', 'Image-{:02d}-FPS'.format(self.args.fps), item[0]+'_'+item[1].zfill(6)+'.mp4')
                    audio_dir = os.path.join('./train_test_data/vggsound/', 'audio/test-audios/test-set', item[0]+'_'+item[1].zfill(6)+'.wav')
                    # if (os.path.exists(video_dir)):
                    #     print(os.path.exists(video_dir))
                    # if (os.path.exists(audio_dir)):
                    #     print(os.path.exists(audio_dir))
